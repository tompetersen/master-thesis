...
} genutzten\todo{Fußnote: Satzbau nicht schlüssig oder? und gilt damit als geeignet für den Fokus dieser Arbeit? Vielleicht lieber Zielsetzung, als Fokus, oder?} Weg des Datenerhalts in OSSIM beschränkt: das Entgegennehmen der Daten über das Syslog-Protokoll (siehe Abschnitt \ref{sec_basics_siem_syslog}). Lösungen für weitere Wege (siehe Abschnitt \ref{subsec_state_siem_parsing}) sind bei Bedarf jedoch auf vergleichbarem Weg zu implementieren.
