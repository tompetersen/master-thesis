...
In diesem Kapitel soll der aktuelle Stand der Forschung und Entwicklung bezogen auf die in dieser Arbeit verwendeten Klassen von Systemen bzw. Verfahren betrachtet sowie ausgehend von den Anforderungen an das zu entwickelnde System passende Lösungen ausgewählt und in für folgende Kapitel notwendiger Detailtiefe beschrieben werden. \todo{Mach zwei Sätze aus diesem Elefantensatz. Außerdem "soll" weg. Schreib selbstbewusst! In diesem Kapitel wird der aktuelle Stand der Forschung.... betrachtet. Ausgehend von den Anforderungen an das zu entwickelnde System werden passende Lösungen ausgewählt und in relevanter Detailtiefe beschrieben.}
