...
\begin{description}
  \item[Außenstehender] Als Außenstehender wird hier jeder Akteur verstanden, der keinen legitimen Zugriff auf Teile des Systems besitzt. Gemeint sind also genauso Mitarbeiter in einem Unternehmensnetzwerk, in dem das System genutzt wird, wie externe Angreifer. Sind die beschriebenen Zugriffsmechanismen\todo{ref} korrekt umgesetzt, bleibt Außenstehenden nur noch das passive Beobachten von Nachrichten. Durch den Einsatz der Transportverschlüsselung \todo{ref} erfahren sie jedoch keine brauchbaren Informationen.
