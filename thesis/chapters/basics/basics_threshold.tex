...
Im Folgenden sei \(\mathbb{G}\) eine zyklische Gruppe der Ordnung \(p\), wobei \(p\) eine Primzahl darstellt, und \(g\) ein Generator dieser Gruppe. Diese Parameter sind öffentlich bekannt. 
